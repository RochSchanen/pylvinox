...
# modified: 2021 june 20 Sunday
# modification:
# author: roch schanen
# comment:
#   make this file executable: ">chmod u+x ./pylvinox.py"
#   usage : ">./pylvinox.py"
...
if __name__ == "__main__":
    ...
    print("file: pylvinox.py")
    print("content: kelvinox interface")
    print("created: 2020 october 11 Sunday")
    print("modified: 2021 june 20 Sunday")
    ...
    # from pyvigi.theme import DEBUG as DEBUG_theme
    # DEBUG_theme('on')
    ...
    class myApp(app):
        ...
        def Start(self):
            ...
            for name, x, y in [
                ...
                # create
                l = Switch(self.Panel, imageSelect(ledc))
                # place
            ...
            for name, x, y in [
                ...
                # create
                s = LEDSwitch(self.Panel, imageSelect(switchc))
                # place
        ...
        def Gn(self, X, Y, name):
            ...
            d = bitmapControl(self.Panel, digitsd)
        ...
        # def serialTransaction(self, i, s):

        #     # perform command and queries
        #     r = s
        #     # return result
        #     return r
